...
public interface CilVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code class_method}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_method(CilParser.Class_methodContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_class}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_class(CilParser.Class_classContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_event}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_event(CilParser.Class_eventContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_property}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_property(CilParser.Class_propertyContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_field}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_field(CilParser.Class_fieldContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_data}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_data(CilParser.Class_dataContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_security}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_security(CilParser.Class_securityContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_externalSource}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_externalSource(CilParser.Class_externalSourceContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_customAttribute}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_customAttribute(CilParser.Class_customAttributeContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_size}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_size(CilParser.Class_sizeContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_pack}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_pack(CilParser.Class_packContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_export}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_export(CilParser.Class_exportContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_methodOverride}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_methodOverride(CilParser.Class_methodOverrideContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_language}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_language(CilParser.Class_languageContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_compilationControl}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_compilationControl(CilParser.Class_compilationControlContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_param}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_param(CilParser.Class_paramContext ctx);
	/**
	 * Visit a parse tree produced by the {@code class_interfaceImpl}
	 * labeled alternative in {@link CilParser#classDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClass_interfaceImpl(CilParser.Class_interfaceImplContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code method_emitbyte}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_emitbyte(CilParser.Method_emitbyteContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_sehblock}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_sehblock(CilParser.Method_sehblockContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_maxstack}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_maxstack(CilParser.Method_maxstackContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_locals}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_locals(CilParser.Method_localsContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_entrypoint}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_entrypoint(CilParser.Method_entrypointContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_zeroinit}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_zeroinit(CilParser.Method_zeroinitContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_datadecl}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_datadecl(CilParser.Method_datadeclContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_instruction}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_instruction(CilParser.Method_instructionContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_security}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_security(CilParser.Method_securityContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_externalSource}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_externalSource(CilParser.Method_externalSourceContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_language}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_language(CilParser.Method_languageContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_customAtribute}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_customAtribute(CilParser.Method_customAtributeContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_compilerControl}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_compilerControl(CilParser.Method_compilerControlContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_export}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_export(CilParser.Method_exportContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_vtentry}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_vtentry(CilParser.Method_vtentryContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_override}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_override(CilParser.Method_overrideContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_scopeBlock}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_scopeBlock(CilParser.Method_scopeBlockContext ctx);
	/**
	 * Visit a parse tree produced by the {@code method_dparam}
	 * labeled alternative in {@link CilParser#methodDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethod_dparam(CilParser.Method_dparamContext ctx);
	/**
